...
/// Searchable, filterable list of all past scans for the current user.
///
/// Filter chips allow narrowing to URL / SMS / Email / Password scan types.
/// Scans are streamed live from Firestore via [UrlScanService.getUserScans].
          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                  content: Text('Clear history feature coming soon!')));
            },
          ),
        ],
      ),
            ...
            child: StreamBuilder<List<ScanModel>>(
              ...
              builder: (context, snapshot) {
                ...
                final filteredHistory = scans.where((item) {
                  ...
                  if (item.provider.contains('Password')) {
                    type = 'Password';
                  }
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        leading: Container(
                          ...
                          decoration: BoxDecoration(
                            color: _getRiskColor(item.result)
                        ...
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text(
                                    'Opening detailed threat report...')),
                          );
                        },
                      ),
                    );
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Try adjusting your filters or run a new scan.',
              style: TextStyle(
                  color: isDark
                      ? const Color(0xFF666666)
                      : AppColors.grey)),
