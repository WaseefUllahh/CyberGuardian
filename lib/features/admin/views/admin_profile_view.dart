              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(email, style: TextStyle(fontSize: 14, color: Colors.white.withValues(alpha: 0.8))),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isDark ? const Color(0xFF1E1E1E) : Colors.white,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: isDestructive ? Colors.red.withValues(alpha: 0.3) : (isDark ? const Color(0xFF333333) : const Color(0xFFEEEEEE))),
        ),
        child: Row(
          children: [
            Container(
