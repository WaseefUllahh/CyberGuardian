...
class AuthField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = isDark ? const Color(0xFF3A3A3A) : AppColors.grey.withValues(alpha: 0.25);
...
class _GeometricPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
      Rect.fromCircle(center: topLeftCenter, radius: radius),
      0, 1.2, false, gearPaint,
    );
    canvas.drawArc(
      Rect.fromCircle(center: topLeftCenter, radius: radius),
      1.5, 1.2, false, gearPaint,
    );
    canvas.drawArc(
      Rect.fromCircle(center: topLeftCenter, radius: radius),
      3.0, 1.5, false, gearPaint,
    );
